    ...
    try {
      ...
      id = MyID();
                ...
                else if (s.compareTo("void") == 0)
                {
                        ...
                        {if (true) throw new ParseException("Unknown type of function"+ id);}
      jj_consume_token(47);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case VARIABLE_TYPE:
      case CONST:
      ...
      FunctionBody();
          ...
          jjtc000 = false;
                if (!curEnv.isReturned())
                        {if (true) throw new ParseException("Function "+ id + "() not return");}
                curEnv = savedEnv;
    } catch (Throwable jjte000) {
          if (jjtc000) {
            jjtree.clearNodeScope(jjtn000);
...
/** function parameter. */
  final public Type FunctionParameter() throws ParseException {
    ...
    try {
      ...
      id = MyID();
                ...
                if (s.compareTo("int") == 0)
                        ...
                        {if (true) throw new ParseException("Invalid type function parameters: "+ id);}
                curEnv.put(id, type);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ASSIGNMENT_EQUAL_OPERATOR:
      case 42:
      ...
      id = MyID();
                        ...
                        if (t != null)
                        {
                                ...
                                if (s.compareTo("int") == 0)
                                        ...
                                        {if (true) throw new ParseException("Invalid type in forStatement");}
                                curEnv.put(id, type);
                        }
                        else
                        {
                                type = curEnv.get(id);
                                if (type == null)
                                        {if (true) throw new ParseException("Undifine id in forStatement: " + id);}
                                else if (type.isFunc)
                                        {if (true) throw new ParseException("Error type in forStatement");}
                        }
      jj_consume_token(ASSIGNMENT_EQUAL_OPERATOR);
      paraL = Expression();
                        if ((type == Type.Int) && ((jjtn000.typeRight != Type.Int) && (jjtn000.typeRight != Type.Char)))
                                {if (true) throw new ParseException("Error type in forStatement: / " + type.name + " " + jjtn000.typeRight.name);}
      ...
      case 72:
        paraL = Expression();
                        if (funcType == Type.Void)
                                {if (true) throw new ParseException("Error type of return");}
                        else if ((funcType == Type.Int) && ((jjtn000.typeRight != Type.Int) && (jjtn000.typeRight != Type.Char)))
                                {if (true) throw new ParseException("Error type of return /" + funcType.name + " " + jjtn000.typeRight.name);}
                        else if ((funcType == Type.Real) && (!Type.numeric(jjtn000.typeRight)))
                                {if (true) throw new ParseException("Error type of return /" + funcType.name + " " + jjtn000.typeRight.name);}
                        else if (funcType != jjtn000.typeRight)
                                {if (true) throw new ParseException("Error type of return /" + funcType.name + " " + jjtn000.typeRight.name);}
                        curEnv.setReturned(true);
 ...
 /*@bgen(jjtree) AssignmentExpression */
    ...
    try {
      lhs = LeftSide();
                ...
                {
                        if (i == -1)
                                {if (true) throw new ParseException("Invalid access to array: "+ lhs);}
                        s = type.name;
                        if (s.compareTo("int") == 0)
                                type = Type.Int;
                        else if (s.compareTo("bool") == 0)
                                ...
                                {if (true) throw new ParseException("Invalid type of array: "+ lhs);}
                }
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) Primary */
    ...
    try {
      ...
      case IDENTIFIER:
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case 47:
          isFuncInvoke = FunctionInvoke(lhs);
          break;
        default:
          jj_la1[53] = jj_gen;
          ;
          ...
          jjtc000 = false;
                if(isFuncInvoke)
                {
                        ...
                        if (type == null)
                                {if (true) throw new ParseException("Undifine function: "+ lhs);}
                        jjtn000.typeRight = type;
                        jjtn000.setName(lhs);
                        {if (true) return 0;}
                }
...
/** FunctionInvoke. */
  final public boolean FunctionInvoke(String id) throws ParseException {
 /*@bgen(jjtree) FunctionInvoke */
        ASTFunctionInvoke jjtn000 = new ASTFunctionInvoke(JJTFUNCTIONINVOKE);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);ArrayList<Type> paras = funcTable.get(id).getParas();
    ...
    try {
      ...
      case 72:
        Expression();
                        temParas.add(jjtn000.typeRight);
        label_18:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
          case 41:
      ...
      jj_consume_token(48);
          ...
          jjtc000 = false;
                if(paras.size() != temParas.size())
                        {if (true) throw new ParseException("Unmatched size of array parameters: "+ id);}
                for(int i = 0; i < paras.size(); i++)
                {
                        Type type1 = paras.get(i);
                        Type type2 = temParas.get(i);
                        if (((type1 == Type.Bool) && (type2 != Type.Bool)) || ((type1 != Type.Bool) && (type2 == Type.Bool)))
                                {if (true) throw new ParseException("Unmatched type in function parameters: " + id);}
...
/** primary2. */
  final public int Primary2() throws ParseException {
    ...
    try {
      ...
      case 73:
        ...
        case 42:
          ...
          paraR = Expression();
                                if ((jjtn000.typeRight != Type.Int) && (jjtn000.typeRight != Type.Char))
                                        {if (true) throw new ParseException("Error type of index when referring array: "+ t1.image);}
